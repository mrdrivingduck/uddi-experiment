...
public class Discover {
    ...
    public Discover() {
        try {
            ...
            UDDIClient client = new UDDIClient("META-INF/discover-uddi.xml");
    ...
    /**
     * This function is useful for translating UDDI's somewhat complex data format
     * to something that is more useful.
     *
    ...
    private void PrintBindingTemplates(BindingTemplates bindingTemplates) {
        ...
        for (int i = 0; i < bindingTemplates.getBindingTemplate().size(); i++) {
            ...
            // So if you have a wsdlDeployment useType, fetch the wsdl and parse for the
            // invocation URL
            // If its hosting director, you'll have to fetch that data from uddi recursively
            // until the leaf node is found
